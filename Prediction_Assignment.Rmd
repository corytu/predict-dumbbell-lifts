---
title: "Predicting “How Well” People Perform Barbell Lifts"
author: "Yu-Zhen Tu"
date: "2017/5/16"
...
## Background
People often quantify _how much_ they perform exercises, but little investigation focuses on _how well_ they do exercises. This dataset is aimed to study how our body parts move when doing barbell lifts correctly. Further information about the data can be found in "Weight Lifting Exercises Dataset" section of the data source page below.
...
### Variable selection
The "classe" variable in the training set indicates five types of doing barbell lifts, where only type A stands for exactly correct way and the other four types stand for common mistakes.
...
If one tree is not enough, how about a forest? I used `rfcv` function to perform cross-validation of the built random forests. The errors show that, when using my selected 12 variables, the error can be reduced to about 0.009, which is less than 1%. Besides, the error drops remarkably when the used variable number increases from 1, 3, 6, to 12.
